...

    {
      ...
      blocks: [
        ...
        },
        {
          ...
          paragraphs: [
            "Week 9 is Character Arc — Change, Resistance, and the Refusal to Change. Character arc is not the same as character change — the arc is the character's journey through the story's pressure, which may end in transformation, in deepened resistance, or in the tragic confirmation of everything the character has refused to learn. Week 9 studies how arc is generated by the collision of character psychology with story situation, how it is tracked across the full manuscript, and how revision can deepen an arc that has been present but underdeveloped.",
          ],
        },
      ],
    },
