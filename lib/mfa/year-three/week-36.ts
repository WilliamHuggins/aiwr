...
export const yearThreeWeek36Data: WeekData = {
  weekNumber: 36,
  totalWeeks: 36,
  semesterLabel: "Spring Semester",
  phaseLabel: "The Completion",
  title: "The Completion — What the Program Has Made",
  emphasizedWord: "Beginning",
  deck: "The final week of the program. There is no craft instruction this week — there is only the reckoning. Three years, 108 weeks, approximately 300 hours of structured craft study, 28 AI-integrated exercises, 60 grammar topics, and somewhere between 80,000 and 150,000 words of original writing, including the thesis manuscript. The completion of a serious writing program is not an ending. It is a beginning.",
  meta: [
    { label: "Commitment", value: "As long as it takes" },
    { label: "Program Week", value: "108 of 108" },
    { label: "Craft Focus", value: "The Reckoning — Who You Are, What You Have Built, What Comes Next" },
    { label: "Grammar", value: "The Last Exercise — One Sentence" },
    { label: "Deliverable", value: "The Year Three Synthesis Statement (1,000 words) + The Last Sentence" },
  ],
  sections: [
    {
      id: "lecture",
      label: "Craft Lecture",
      title: "The Scaffolding Is Going Away — What Remains",
      blocks: [
        {
          type: "paragraph",
          content: [
        ...
        {
          type: "pullquote",
          quote: "The work is never finished. Every published book is a draft that the writer was eventually willing to release into the world. The difference between a completed thesis and an abandoned draft is not perfection — it is the commitment to release. You have committed. You have released. The work is in the world, and you are already beginning again.",
          cite: "— final editorial tip of the program",
        },
        {
          type: "card",
          title: "What the Program Has Made — A Full Accounting",
          paragraphs: [
        ...
        {
          type: "card",
          title: "The Writer You Are Now — The Questions Worth Sitting With",
          paragraphs: [
...

    {
      ...
      title: "What Comes Next in Each Track",
      blocks: [
        {
          type: "genreGrid",
          items: [
            {
              ...
              variant: "lf",
              text: "The fiction writer leaving the program carries a completed manuscript in the world — submitted to agents, with the submission package built and in circulation, with the query letter doing its professional work. The next project is in its seed phase. The essay practice is established. The submission habit is in place. What comes next: the query process, which requires equanimity and persistence in roughly equal measure; the next fiction project, which will develop on its own timeline; and the reading life, which is the primary ongoing classroom. The fiction writer's most useful post-program practice is the craft reading journal — the annotated record of what every book teaches, accumulated over years, against which the developing work can be measured.",
            },
            {
...

    {
      id: "grammar",
      label: "Grammar & Style",
      title: "The Last Exercise",
      blocks: [
        {
          type: "grammar",
          title: "One Sentence — The Full Curriculum Embodied",
          intro: [
          ...
          rule: "Write the best sentence you can write. Not the cleverest. Not the most technically sophisticated, though it should be technically accomplished. The truest — the sentence that most fully embodies everything you've learned about how language moves, in service of something you genuinely care about saying. One sentence. Take as long as you need. When you have it: copy it out by hand. Put it somewhere you will see it every day. It is the standard you have set for yourself. Every sentence you write from here forward is reaching toward it.",
          examples: [
            {
              label: "What the last exercise is actually measuring",
              text: "The last sentence is not a demonstration of grammatical knowledge — it is the synthesis of grammatical knowledge and genuine subject matter and earned voice. The sentence that deploys every Phase 1 through Phase 8 concept correctly but says nothing that matters is not the sentence the exercise asks for. The sentence that says something true in a way only this writer could say it — that is the sentence. The grammar serves the truth. It has always been in service of the truth. That is what the three-year curriculum was for.",
            },
          ],
          outro: [
...

    {
      ...
      title: "The Year Three Synthesis Statement — Who You Are as a Writer",
      blocks: [
        {
          type: "exercise",
          paragraphs: [
          ...
          target: "1,000-word Year Three synthesis statement — aesthetic commitments, subject matter, voice, what comes next — written as literature, not administrative writing",
        },
      ],
    },

    {
      id: "ai",
      label: "AI Workshop",
      title: "The Forward Assessment — Strengths, Frontier, Advice",
      blocks: [
        {
          type: "ai",
      ...
      blocks: [
        {
          type: "tip",
          icon: "✦",
          name: "The Work Is Never Finished — and You Are Already Beginning Again",
          paragraphs: [
...

    {
      ...
      title: "The First Sentence of the Next Thing",
      blocks: [
        {
          type: "journal",
          title: "You Have Never Needed Permission to Begin",
          question:
...

    {
      ...
      blocks: [
        ...
        {
          type: "card",
          title: "The Full Program — What Was Built Across Three Years",
          paragraphs: [
