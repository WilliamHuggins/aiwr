    ...
    <div className="mx-auto max-w-4xl px-6 py-16">
      <div className="rounded-3xl border border-border bg-panel p-10 shadow-sm">
        ...
        <div className="mt-8 flex gap-3">
          <Link href="/writers-circle/signup" className="rounded-xl bg-primary px-5 py-3 text-primaryText no-underline">Join the Circle</Link>
          <Link href="/writers-circle/login" className="rounded-xl border border-border px-5 py-3 no-underline">Log in</Link>
        </div>
