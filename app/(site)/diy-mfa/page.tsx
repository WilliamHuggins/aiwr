    ...
    semesters: [
      ...
      },
      {
        ...
        weeks: [
          ...
          [30, "Thesis Realignment for Next-Stage Work", "Translate the completed thesis into the next project's opening architecture with a focused ten-page prospectus."],
          [31, "Curriculum Retrospective as Method", "Audit three years of craft study and extract the operating methods that will guide your post-program writing life."],
          [32, "Aesthetic Declaration and Publication Strategy", "Finalize a clear artistic statement and actionable submission plan for essays, excerpts, and residency materials."],
