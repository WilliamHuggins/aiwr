  ...
  const lesson = {
    ...
    content: `
      ...
      <div class="p-4 border rounded-xl bg-gray-50 dark:bg-gray-800">
        ...
        <p><strong>1. My Goals:</strong> What do I want to achieve with my writing in the next two years? (Be specific: "Finish a novel draft," not "Become a better writer.")</p>
        <p><strong>2. My Schedule:</strong> When and where will I write? State the exact days, times, and location. (e.g., "Mon-Fri, 6 AM to 7 AM, at the kitchen table.")</p>
        <p><strong>3. My Rules:</strong> What will I do to protect my writing time? (e.g., "My phone will be off," "I will not check email before my session is over.")</p>
        <p><strong>4. My Promise:</strong> A one-sentence declaration of your commitment to the craft, to be revisited when you feel discouraged.</p>
      </div>
      ...
      <p><strong>Preview:</strong> In Lesson 2, now that we've established our discipline, we will build the engine of all narrative: Character. We will learn how a character's deep-seated motivations create a plot that is both inevitable and surprising.</p>
    `,
  };
