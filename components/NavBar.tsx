  ...
  return (
    <header className="sticky top-0 z-20 border-b border-border bg-bg/95 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        <Link href="/writers-circle/app" className="no-underline font-serif text-xl font-semibold">AIWR Writer&apos;s Circle</Link>
        <nav className="flex items-center gap-3 text-sm">
          ...
          {isAdminOrMod && <Link href="/writers-circle/app/admin" className="rounded-lg px-3 py-1 no-underline">Admin</Link>}
